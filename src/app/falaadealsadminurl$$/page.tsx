    ...
    <div className="min-h-screen bg-background p-6 lg:p-10 space-y-10 max-w-7xl mx-auto">
      <header className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
           <Button variant="outline" className="border-white/5 bg-card" onClick={fetchData} disabled={loading}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-card border-white/5 shadow-xl">
          <CardContent className="pt-6">
            ...
            <div className="mt-4">
              <div className="text-2xl font-black">{data?.stats.totalUsers || 0}</div>
        ...
        <Card className="bg-card border-white/5 shadow-xl">
          <CardContent className="pt-6">
            ...
            <div className="mt-4">
              <div className="text-2xl font-black">GHS {data?.stats.todayDeposits.toFixed(2) || '0.00'}</div>
        ...
        <Card className="bg-card border-white/5 shadow-xl">
          <CardContent className="pt-6">
            ...
            <div className="mt-4">
              <div className="text-2xl font-black">{data?.stats.todayOrders || 0}</div>
        ...
        <Card className="bg-primary text-primary-foreground border-none shadow-xl shadow-primary/20">
          <CardContent className="pt-6">
            ...
            <div className="mt-4">
              <div className="text-2xl font-black">GHS {data?.stats.rahitaluBalance.toFixed(2) || '0.00'}</div>
